...
import { PublicationService } from '../../publication/_services/publication.service';
...
@Component({
  ...
  styleUrls: ['./show-produit.component.scss']
})
...
private subscriptions: Subscription[] = []; // Read more: => https://brianflove.com/2016/12/11/anguar-2-unsubscribe-observables/ 
  ...
  get() {
    this.Produits = null;
    this.ProduitsService.getAllProduits().subscribe(list => {
      this.Produits = list;
